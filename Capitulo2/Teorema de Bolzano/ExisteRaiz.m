%   ExisteRaiz(inicio, final, funcion) 
%
%       [ IntCorrecto, Xa, Xb ] = ExisteRaiz( inicio, final, funcion )
%       IntCorrecto = Variable booleana que verifica si el intervalo dado inicialmente contiene una raiz 
%       Xa = Inicio del intervalo acotado   
%       Xb = Final del intervalo acotado
%       fun = la función a tratar
%       [inicio,final] intervalo inicial que sera acotado
